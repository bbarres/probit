...
##############################################################################/
#building tables to make an analyze that merges the different repetition####
##############################################################################/
...
##############################################################################/
#2nd set of clones: comparison between repetitions####
##############################################################################/
...
##############################################################################/
#3d set of clones: comparison between repetitions
##############################################################################/
...
#let's evaluate the different model for each clone with and without pbo####
myzus.sspbo<-drm(dead/total~dose,weights=total,
                 data=myzpbo[myzpbo$clone==names(summary(myzpbo[,2]))[5] & 
                               myzpbo$pesticide=="thiaclopride",],
                 fct=LN.2(),
                 type="binomial")
plot(myzus.sspbo,type="confidence",main=names(summary(myzpbo[,2]))[5])
plot(myzus.sspbo,type="obs",add=TRUE)
...
plot(myzus.sspbo,type="obs",main=names(summary(myzpbo[,2]))[5])
plot(myzus.sspbo1,type="confidence",add=TRUE,col="blue")
plot(myzus.sspbo1,type="obs",add=TRUE,col="blue",pch=19)
plot(myzus.sspbo2,type="confidence",add=TRUE,col="blue2")
plot(myzus.sspbo2,type="obs",add=TRUE,col="blue2",pch=19)
